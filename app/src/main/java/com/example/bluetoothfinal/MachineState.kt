...
class MachineState {
    ...
    companion object {
        ...
        const val  MANUAL_PROGRAMMING_START = 4                        // For manual setting of travel & load motor step positions
        ...
        const val  MANUAL_PROGRAMMING_COMPLETE = 9
        ...
        const val SAVE_MOTOR_POSITIONS = 17

        const val MASSAGE_STOP = 18
